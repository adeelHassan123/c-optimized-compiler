...
A complete, high-transparency compiler pipeline implementing all eight modules of the Compiler. This project integrates tool-based (Flex/Bison) and hand-written components into a unified, diagnostic-rich compiler.
